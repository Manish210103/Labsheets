...
public class PensionCalc {
    public static void main(String[] args) {
        ...
        System.out.printf("The employee's contribution is: $%.2f%n", (employeeContribution*10));
        System.out.printf("The employer's contribution is: $%.2f%n", (employerContribution*10));
        System.out.printf("The total contribution is: $%.2f%n", (10*totalContribution));
        scanner.close();
    }
}
